...
public class SceneController {
    ...
    public void cambiarAEstanteriaVirtual(MouseEvent event){
        cambiarEscena(event, Paths.PANEL_ESTANTERIA_FXML);
    }
    ...
    public void cambiarAPanelLoginProfesor(ActionEvent event){
        cambiarEscena(event, Paths.PANEL_LOGIN_PROFESOR_FXML);
    }

    public void cambiarAlPanelLoginEstudiante(ActionEvent event){
        cambiarEscena(event, Paths.PANEL_LOGIN_ESTUDIANTE_FXML);
    }

    public void cambiarAlPanelProfesores(ActionEvent event){
        cambiarEscena(event, Paths.PANEL_PROFESORES_FXML);
    }
    public void cambiarAlPanelEstudiantes(ActionEvent event){
        cambiarEscena(event, Paths.PANEL_ESTUDIANTES_FXML);
    }
}